...
<div id="mobile-panes">
    <h4>
        <span class="active" data-offset="0">Music</span> / 
        <span data-offset="1">Art</span> / 
        <span data-offset="2">New</span> / 
        <span data-offset="3">Popular</span>
    </h4>
</div>
<div id="container">